# Day 6: Equal Sum Span

## Details
- Difficulty: Medium
- Pattern: Prefix sum + hashmap [cite: 6]
- Challenge: GeeksforGeeks 60-Day Challenge [cite: 2]

## Problem Logic
- This problem was solved using the Prefix sum + hashmap technique[cite: 9].
...
---
## ✅ Verification
![Test Case Result](../assets/Day06_25Feb(2).png)
