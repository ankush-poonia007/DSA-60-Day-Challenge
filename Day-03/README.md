...
## Details
- Difficulty: Medium
- Pattern: Sort + greedy [cite: 6]
- Challenge: GeeksforGeeks 60-Day Challenge [cite: 2]

## Problem Logic
- This problem was solved using the Sort + greedy technique[cite: 9].
...
---
## ✅ Verification
![Test Case Result](../assets/Day03_22Feb(2).png)
*Passed all test cases on GeeksforGeeks.*

---
## ✅ Verification
![Test Case Result](../assets/Day03_21Feb(2).png)
*Passed all test cases on GeeksforGeeks.*